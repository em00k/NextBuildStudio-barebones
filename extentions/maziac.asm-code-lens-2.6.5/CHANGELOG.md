...
# 2.6.3
- Fix for [#110](https://github.com/maziac/asm-code-lens-issues/issues/110): sjasmplus @ labels in modules are not recognised correctly
...
# 2.4.1
- Outline view: [#98](https://github.com/maziac/asm-code-lens-issues/issues/98): Properly show symbol kinds and structs/modules in document outline by mwpenny
...
# 2.2.0
- Reduced package size a lot due to PR [#90](https://github.com/maziac/asm-code-lens-issues/issues/90) by Crystal-RainSlide.
- Fixed [#84](https://github.com/maziac/asm-code-lens-issues/issues/84): Refactoring of all vscode providers. Especially the code lens provider. The way there were used did not work in all multiroot configurations. This should be fixed now.
...
- Fixed [#87](https://github.com/maziac/asm-code-lens-issues/issues/87): # comment

# 2.1.0
- Fixed incompatibility with vscode 1.74.

# 2.0.2
- Fixed [#83](https://github.com/maziac/asm-code-lens-issues/issues/83): incorrect behavior "$problem-matcher-sjasmplus". Now also supports absolute paths.
- Fixed [#82](https://github.com/maziac/asm-code-lens-issues/issues/82): Another codepages. Hovering now honors the vscode code page settings of the file.
...
- Fix for references after quotes (issue [#69](https://github.com/maziac/asm-code-lens-issues/issues/69))

# 1.9.1
- Wider references for code lenses and "Find labels with no Reference": Fixed [#68](https://github.com/maziac/asm-code-lens-issues/issues/68)
- Delayed activation event to "onStartupFinished"

# 1.9.0
- Added PR [#65](https://github.com/maziac/asm-code-lens-issues/issues/65): Add syntax highlight to Markdown code blocks.
...
- Fixed recognition of global labels for sjasmplus in code lenses. Issue [#49](https://github.com/maziac/asm-code-lens-issues/issues/49).
...
# 1.7.1
- Solved issue [#54](https://github.com/maziac/asm-code-lens-issues/issues/54): Using "# " as comment instead of "#".
...
# 1.6.4
- Fixed [#52](https://github.com/maziac/asm-code-lens-issues/issues/52): CamelCase filename issue in Linux.
...
# 1.6.2
- Regression fixed: Issue [#30](https://github.com/maziac/asm-code-lens-issues/issues/30): Goto definition to local label not working
...
# 1.5.8
- Fixed [#46](https://github.com/maziac/asm-code-lens-issues/issues/46): Syntax highlighting: clash of Z80 vs. x86
...
# 1.5.7
- Fixed IFN highlighting [#44](https://github.com/maziac/asm-code-lens-issues/issues/44) thanks to kborowinski.
- Fixed line comment toggling [#45](https://github.com/maziac/asm-code-lens-issues/issues/45)
...
# 1.5.3
- Fixes:
	- [#40](https://github.com/maziac/asm-code-lens-issues/issues/40): "Hover display incorrect"
	- [#41](https://github.com/maziac/asm-code-lens-issues/issues/41): "No completion of local label"

# 1.5.2
- Fixes:
	- [#39](https://github.com/maziac/asm-code-lens-issues/issues/39): "Wrong substitution: e.label"
	- [#38](https://github.com/maziac/asm-code-lens-issues/issues/38): "Completion: wrong label"
	- [#37](https://github.com/maziac/asm-code-lens-issues/issues/37): "Outline: Data label shown as code"
	- [#36](https://github.com/maziac/asm-code-lens-issues/issues/36): "Outline: STRUCTs wrong."
	- [#34](https://github.com/maziac/asm-code-lens-issues/issues/34): "local labels not recognized properly?"
	- [#33](https://github.com/maziac/asm-code-lens-issues/issues/33): "Quarte in binary numbers highlighted wrong"
	- [#32](https://github.com/maziac/asm-code-lens-issues/issues/32): "ENDS not correctly colored"
	- [#31](https://github.com/maziac/asm-code-lens-issues/issues/31): "Some grammar for Z80N missing"
	- [#30](https://github.com/maziac/asm-code-lens-issues/issues/30): "Goto definition to local label not working"
...
## 1.4.3/4
- Fixed issue [#23](https://github.com/maziac/asm-code-lens-issues/issues/23) for Linux.
