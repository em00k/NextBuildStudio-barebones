...
# 1.2.0
- Feature request [#3](https://github.com/maziac/hex-hover-converter/issues/3): Support for SystemVerilog number format, hex and binary formats are supported now (e.g. 'h7F123A).
- Allows now underscores to be separators for the hex number, e.g. 0xAABB_CCDD.

# 1.1.2
- Fixed accuracy problem for very large numbers. Issue [#2](https://github.com/maziac/hex-hover-converter/issues/2).
