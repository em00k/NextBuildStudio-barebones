...
# 1.2.3
- Fix for [#17](https://github.com/maziac/z80-instruction-set/issues/17): Flags for INI/INIR/IND/INDR/OUTI/OUTD/OTIR/OTDR and IN x,(C)

# 1.2.2
- Fix for [#15](https://github.com/maziac/z80-instruction-set/issues/15): Incorrect description of the effect on the carry flag in I/O commands.
...
# 1.2.1
- Fix for [#13](https://github.com/maziac/z80-instruction-set/issues/13): Don't recognize RST with # number

# 1.2.0
- Packed with esbuild.
- Fixed [#14](https://github.com/maziac/z80-instruction-set/issues/14): Wrong legend inc ix
- activationEvent changed to "onStartupFinished".
- Tests changed from Mocha to jest.

# 1.1.1
- Fixed [#6](https://github.com/maziac/z80-instruction-set/issues/6): RST not shown correctly: "RST 0"
